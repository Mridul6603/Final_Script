...
def main():
    ...
    image_url = download_image('https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/SNice.svg/220px-SNice.svg.png')
    image_data = save_image_file(image_url, r'C:\Users\Owner\Desktop\SEMESTER4\Scripting\Final_Script\image.jpg')
    return
